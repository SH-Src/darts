...
def searching_phase(args, device):
	...
	darts = model_cls(C, num_cells, num_nodes, num_classes, criterion, gpus=gpus)
	...
	test_queue = torch.utils.data.DataLoader(test_data, batch_size=args.batch_size, shuffle=True, pin_memory=True, num_workers=4)
