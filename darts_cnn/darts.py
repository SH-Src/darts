...
class Darts(nn.Module):
    ...
    def second_order_approximation(self, X_train, Y_train, X_val, Y_val):
        ...
        alpha_grads = [alpha.grad for alpha in
                       unrolled_model.arch_parameters]  # derivative of loss_val w.r.t architecture parameters
        w_prime_grads = [w_prime.grad for w_prime in
                         unrolled_model.parameters()]  # derivative of loss_val w.r.t w' parameters
